...
class Intro {
    ...
    init() {
        ...
        select("#home-intro").style.marginTop = (this.windowHeight - select("#home-intro").offsetHeight) + "px";
    ...
    setupScene() {
        ...
        this.drawCanvas = new DrawCanvas(this.windowWidth, this.windowHeight, select("#drag-canvas")); 
