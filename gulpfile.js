...
gulp.task('libscripts', function () {
	...
	var src = 	[
			...
			config.bower + "svg.js/dist/svg.js",
			...
			config.bower + "three-effectComposer/shaders/HorizontalBlurShader.js",
			config.bower + "three-effectComposer/shaders/VerticalBlurShader.js",
			config.bower + "three-effectComposer/shaders/FXAAShader.js",
			config.bower + "three-effectComposer/shaders/TriangleBlurShader.js",
			config.bower + "three-effectComposer/shaders/CopyBloomShader.js",
			config.bower + "three-effectComposer/js/postprocessing/MaskPass.js",
			config.bower + "three-effectComposer/js/postprocessing/TexturePass.js",
